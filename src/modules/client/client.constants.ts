export const clientZodMessage = {
  INVALID_PHONE: 'Invalid phone number !',
  PHONE_REQUIRED: 'Phone number is required !',
  INVALID_GST_NUMBER: 'Entered GST number is invalid !',
  INVALID_STRING_STRUCTURE: 'Entered string is not following the standards !',
  LOGO_PATH_TOO_LONG: 'Path is taking very long string !',
};
